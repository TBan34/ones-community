...
Post.create!(
[
  {title: 'バッティングセンター（初心者）',                       since_when: 'Sun,  2 Apr 2023 16:00:00.000000000 JST +09:00', at_where: '札幌市内のバッティングセンター', for_playing: 'なし',                       body: %Q{WBCの影響でバッティングセンターに行き始めました\n一緒に行ってくださる方がいれば嬉しいです！},                                                                    status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post1.jpg"),  filename:"sample-post1.jpg"), user_id: users[0].id},
  {title: 'パス練習',                                             since_when: 'Thu,  6 Apr 2023 14:00:00.000000000 JST +09:00', at_where: 'さいたま市周辺',                 for_playing: '特に指定なし',               body: %Q{高校時代はサッカー部に入っていました。\n久しぶりにボールを蹴りたいので、付き合ってもらえる方を募集します。年代性別経験問いません。},                             status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post2.jpg"),  filename:"sample-post2.jpg"), user_id: users[1].id},
  {title: '私をスキーに連れてって',                               since_when: 'Fri,  9 Feb 2024 08:00:00.000000000 JST +09:00', at_where: '北陸又は長野のスキー場',         for_playing: 'スキー道具一式、車',         body: 'スキーに行きたいのですが車がありません😢 どなたか車を出して頂けないでしょうか😿',                                                                                  status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post3.jpg"),  filename:"sample-post3.jpg"), user_id: users[2].id},
  {title: '小学生の息子にサッカーを教えてくださる方を募集します', since_when: 'Sat,  8 Apr 2023 13:30:00.000000000 JST +09:00', at_where: '東京23区内',                     for_playing: '特になし',                   body: '先日小学生になった息子がサッカーを習い始めました。リフティングが苦手なようなので、経験者の方に教えて頂きつつ息子とサッカーで遊んで貰えないかと思い募集しました。', status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post4.jpg"),  filename:"sample-post4.jpg"), user_id: users[3].id },
  {title: '対戦者求む',                                           since_when: 'Wed, 12 Apr 2023 18:00:00.000000000 JST +09:00', at_where: '杉並体育館',                     for_playing: 'バッシュ',                   body: 'バスケの1on1に絶対の自信あり。対戦者募集。',                                                                                                                       status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post5.jpg"),  filename:"sample-post5.jpg"), user_id: users[4].id},
  {title: 'バスケ教えてください！',                               since_when: 'Thu, 20 Apr 2023 17:30:00.000000000 JST +09:00', at_where: '鹿児島市内',                     for_playing: 'バスケットボール、バッシュ', body: %Q{何となく募集してみました。未経験ですが、バスケは好きです。\nのびのび運動できたらと思います！},                                                                   status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post6.jpg"),  filename:"sample-post6.jpg"), user_id: users[5].id},
  {title: '未経験者だが卓球したい！',                             since_when: 'Sun, 23 Apr 2023 14:00:00.000000000 JST +09:00', at_where: '福岡県内の体育館',               for_playing: 'ラケット',                   body: %Q{この間テレビで水谷選手を見て無性に卓球をやりたくなりました。\nラケットは体育館で借りられるとは思います。},                                                       status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post7.jpg"),  filename:"sample-post7.jpg"), user_id: users[6].id},
  {title: '女子バレー練習（高校生）',                             since_when: 'Wed, 26 Apr 2023 18:00:00.000000000 JST +09:00', at_where: '札幌市東区体育館',               for_playing: 'シューズ',                   body: %Q{高校の女子バレー部に所属しています。\n部外で一緒に練習できる友人が欲しいと思い募集しました。},                                                                   status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post8.jpg"),  filename:"sample-post8.jpg"), user_id: users[7].id },
  {title: 'Basket Monster is here',                               since_when: 'Mon,  1 May 2023 13:00:00.000000000 JST +09:00', at_where: 'Tokyo',                          for_playing: 'shoes, ball',                body: 'Nobody beats me. Just do it.',                                                                                                                                     status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post9.jpg"),  filename:"sample-post9.jpg"), user_id: users[8].id },
  {title: '最強バドミントンプレイヤーを目指して',                 since_when: 'Fri,  5 May 2023 17:00:00.000000000 JST +09:00', at_where: '23区内の体育館',                 for_playing: 'ラケット、シャトル',         body: '最強のバドミントンプレイヤーを目指して日々練習しています。大人の方と対戦してみたいです。',                                                                         status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post10.jpg"), filename:"sample-post10.jpg"), user_id: users[9].id },
  {title: '1on1',                                                 since_when: 'Fri, 12 May 2023 18:00:00.000000000 JST +09:00', at_where: '恵庭市総合体育館',               for_playing: 'シューズ',                   body: 'バスケやりましょう！どなたでも歓迎です！',                                                                                                                         status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post11.jpg"), filename:"sample-post11.jpg"), user_id: users[10].id},
  {title: 'ランニングしませんか？',                               since_when: 'Sat, 20 May 2023 10:00:00.000000000 JST +09:00', at_where: '東京近郊',                       for_playing: 'なし',                       body: '健康のために毎日5km走っています。たまには他の方と走ってみたいと思い募集しました。',                                                                                status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post12.jpg"), filename:"sample-post12.jpg"), user_id: users[11].id },
  {title: '人生初の皇居ラン',                                     since_when: 'Sun, 28 May 2023 16:00:00.000000000 JST +09:00', at_where: '皇居周辺',                       for_playing: '動きやすい服装',             body: '人生初の皇居ランに挑戦します。折角なので一緒に走ってくださる方を募集します。',                                                                                     status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post13.jpg"), filename:"sample-post13.jpg"), user_id: users[12].id },
  {title: 'テニス練習',                                           since_when: 'Sat, 10 Jun 2023 14:00:00.000000000 JST +09:00', at_where: '都留テニスランド',               for_playing: 'ラケット',                   body: '日程の調整はききます、一緒にテニスしましょう！',                                                                                                                   status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post14.jpg"), filename:"sample-post14.jpg"), user_id: users[13].id },
  {title: '大阪山登頂',                                           since_when: 'Sat, 24 Jun 2023 06:30:00.000000000 JST +09:00', at_where: '大阪山',                         for_playing: '登山道具一式',               body: '登りましょう。日帰り予定です。',                                                                                                                                   status: 0, image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post15.jpg"), filename:"sample-post15.jpg"), user_id: users[14].id }
]
)
